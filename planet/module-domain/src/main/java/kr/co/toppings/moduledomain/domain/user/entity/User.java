package kr.co.toppings.moduledomain.domain.user.entity;
...
import kr.co.toppings.moduledomain.domain.user.constants.Auth;
import kr.co.toppings.moduledomain.support.entity.BaseEntity;
import kr.co.toppings.moduledomain.support.entity.embedded.Image;
